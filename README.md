...
[**rules.apis.io**](https://rules.apis.io) indexes [Spectral](https://stoplight.io/open-source/spectral) rulesets across the network — provider-published API governance rules that lint OpenAPI specs against an organization\'s naming, security, versioning, and operational standards.

**Live site:** [https://rules.apis.io](https://rules.apis.io)

## What's in this repo

- **`_rules/`** — one Markdown file per ruleset. Front matter carries rule counts by severity (error, warn, info, hint), function summaries, and a link back to the source ruleset YAML.
