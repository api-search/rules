...
- security
- servers
description: Spectral linting rules defining API design standards and conventions for United Technologies.
layout: rules
...
- description: Collins Aerospace API titles should start with "Collins Aerospace".
  given: $.info.title
  name: info-title-collins-prefix
  severity: warn
...
- description: Operations should include x-microcks-operation for mock compatibility.
  ...
  severity: info
rules_file: rules/united-technologies-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/united-technologies/refs/heads/main/rules/united-technologies-spectral-rules.yml
severity_counts:
  error: 13
  hint: 0
  info: 3
...
source_filename: united-technologies-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/united-technologies/refs/heads/main/rules/united-technologies-spectral-rules.yml
tags:
- Aerospace
- Defense
- Aviation
