...
categories:
- spring
description: Spectral linting rules defining API design standards and conventions for Spring Batch.
layout: rules
...
- description: Paginated responses should include page, size, totalElements, and totalPages.
  ...
  severity: warn
rules_file: rules/spring-batch-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/spring-batch/refs/heads/main/rules/spring-batch-rules.yml
severity_counts:
  error: 3
  hint: 0
  info: 1
...
source_filename: spring-batch-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/spring-batch/refs/heads/main/rules/spring-batch-rules.yml
tags:
- Batch Processing
- Data Processing
- Enterprise
