...
- schema
- servers
description: Spectral linting rules defining API design standards and conventions for TheCocktailDB.
layout: rules
...
- description: Operations must have at least one tag
  ...
  severity: warn
- description: Operation summaries should start with 'TheCocktailDB'
...
- description: Operations should have examples
  ...
  severity: info
rules_file: rules/thecocktaildb-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/thecocktaildb/refs/heads/main/rules/thecocktaildb-spectral-rules.yml
severity_counts:
  error: 8
  hint: 0
  info: 2
...
source_filename: thecocktaildb-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/thecocktaildb/refs/heads/main/rules/thecocktaildb-spectral-rules.yml
tags:
- Cocktails
- Drinks
- Recipes
