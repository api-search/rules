...
categories:
- workday
description: Spectral linting rules defining API design standards and conventions for Workday Integration.
layout: rules
...
- description: All operations must have an operationId.
  ...
  name: workday-integration-operation-id-required
  severity: error
- description: All operations must have a summary.
  given: $.paths[*][get,post,put,patch,delete]
  name: workday-integration-summary-required
  severity: error
- description: Operation summaries must use Title Case.
  given: $.paths[*][get,post,put,patch,delete].summary
  name: workday-integration-summary-title-case
  severity: warn
- description: All operations must have at least one tag.
  given: $.paths[*][get,post,put,patch,delete]
  name: workday-integration-tags-required
  severity: error
- description: All operations must have a description.
  given: $.paths[*][get,post,put,patch,delete]
  name: workday-integration-description-required
  severity: warn
- description: Bearer authentication must be defined.
  given: $.components.securitySchemes
  name: workday-integration-bearer-auth
  severity: error
- description: Server URLs must include tenant variable for multi-tenancy.
  given: $.servers[*].url
  name: workday-integration-tenant-in-url
  severity: warn
- description: Collection GET endpoints should support limit parameter.
  given: $.paths[*].get.parameters[*][?(@.name == 'limit')]
  name: workday-integration-pagination-support
  severity: warn
...
- description: Date fields should specify date or date-time format.
  ...
  name: workday-integration-date-format
  severity: warn
rules_file: rules/workday-integration-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/workday-integration/refs/heads/main/rules/workday-integration-rules.yml
severity_counts:
  error: 4
  hint: 2
  info: 0
...
source_filename: workday-integration-rules.yml
...
source_yaml: "extends: spectral:oas\nrules:\n\n  workday-integration-operation-id-required:\n    description: All operations must have an operationId.\n    severity: error\n    given: \"$.paths[*][get,post,put,patch,delete]\"\n    then:\n      field: operationId\n      function: truthy\n\n  workday-integration-summary-required:\n    description: All operations must have a summary.\n    severity: error\n    given: \"$.paths[*][get,post,put,patch,delete]\"\n    then:\n      field: summary\n      function: truthy\n\n  workday-integration-summary-title-case:\n    description: Operation summaries must use Title Case.\n    severity: warn\n    given: \"$.paths[*][get,post,put,patch,delete].summary\"\n    then:\n      function: pattern\n      functionOptions:\n        match: \"^[A-Z]\"\n\n  workday-integration-tags-required:\n    description: All operations must have at least one tag.\n    severity: error\n    given: \"$.paths[*][get,post,put,patch,delete]\"\n    then:\n      field: tags\n     \
  ...
  \    description: Date fields should specify date or date-time format.\n    severity: warn\n    given: \"$.components.schemas[*].properties[?(@property.match(/[Dd]ate$|[Oo]n$|[Aa]t$/))]\"\n    then:\n      field: format\n      function: truthy\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/workday-integration/refs/heads/main/rules/workday-integration-rules.yml
tags:
- Enterprise
- ERP
- Finance
