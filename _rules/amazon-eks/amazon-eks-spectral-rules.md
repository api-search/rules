...
- tag
- tags
description: Spectral linting rules defining API design standards and conventions for Amazon EKS.
layout: rules
...
- description: Operations should include examples for better documentation.
  ...
  severity: info
rules_file: rules/amazon-eks-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/amazon-eks/refs/heads/main/rules/amazon-eks-spectral-rules.yml
severity_counts:
  error: 11
  hint: 0
  info: 4
