...
- server
- servers
description: Spectral linting rules defining API design standards and conventions for Amazon Route 53.
layout: rules
...
- description: DELETE operations should not have a request body
  ...
  severity: warn
rules_file: rules/amazon-route-53-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/amazon-route-53/refs/heads/main/rules/amazon-route-53-spectral-rules.yml
severity_counts:
  error: 8
  hint: 0
  info: 1
