...
- servers
- tags
description: Spectral linting rules defining API design standards and conventions for Tradeweb.
layout: rules
...
- description: ''
  ...
  severity: error
rules_file: rules/tradeweb-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/tradeweb/refs/heads/main/rules/tradeweb-spectral-rules.yml
severity_counts:
  error: 14
  hint: 0
  info: 1
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/tradeweb/refs/heads/main/rules/tradeweb-spectral-rules.yml
tags:
- Electronic Trading
- Financial Markets
- Fixed Income
