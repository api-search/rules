...
- security
- servers
description: Spectral linting rules defining API design standards and conventions for UnitedHealth Group.
layout: rules
...
- description: UnitedHealth Group API titles should start with "UnitedHealth Group".
  given: $.info.title
  name: info-title-unitedhealth-prefix
  severity: warn
...
- description: FHIR APIs should use application/fhir+json content type.
  ...
  name: fhir-content-type
  severity: warn
- description: Operations should include x-microcks-operation for mock compatibility.
  given: $.paths[*][get,post,put,delete,patch]
  name: microcks-operation-present
  severity: info
rules_file: rules/unitedhealth-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/unitedhealth/refs/heads/main/rules/unitedhealth-spectral-rules.yml
severity_counts:
  error: 13
  hint: 0
  info: 2
...
source_filename: unitedhealth-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/unitedhealth/refs/heads/main/rules/unitedhealth-spectral-rules.yml
tags:
- Healthcare
- Health Insurance
- FHIR
